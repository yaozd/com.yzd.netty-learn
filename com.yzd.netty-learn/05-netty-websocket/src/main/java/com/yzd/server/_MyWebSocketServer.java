 ...
 * </ul>
 */
public final class _MyWebSocketServer {

    static final boolean SSL = System.getProperty("ssl") != null;
    static final int PORT = Integer.parseInt(System.getProperty("port", SSL? "8443" : "8002"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new WebSocketServerInitializer(sslCtx, 65535));
